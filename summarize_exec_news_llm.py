...
# bullet_points: 메일 불렛에 그대로 사용. 대상 인물 이름은 작은따옴표(')로 감쌈.
SUMMARY_SCHEMA = """
{
  ...
  "bullet_points": ["불렛1 (인물명은 '이름' 형식)", "불렛2", "..."],
...
[bullet_points]
- is_exec_news: true일 때만 2~5개 불렛 문장 생성. 메일 본문에 그대로 사용됨.
- 한 줄에 하나의 자연스러운 요약 문장. 대상 인물이 있으면 이름 앞뒤에 작은따옴표(') 붙임. 예: '윤종수' KT 사외이사가 연임을 포기함.
...
[참고 예시]
- "KT 윤종수 사외이사 연임 포기", "이사회 물갈이", "거버넌스" → 포함 (사외이사·거버넌스 인사)
